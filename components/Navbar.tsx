...
export const Navbar = () => {
	...
	useEffect(() => {
		const updateCartCount = () =>
			setCartCount(publicShoppingStorage.getCartCount());
		updateCartCount();
		...
		return () => {
			...
			window.removeEventListener(
				"vendorlink-public-cart-updated",
				updateCartCount,
			);
		};
	}, []);
		...
		<>
			...
			>
				<div className="mx-auto flex max-w-6xl items-center justify-between px-6 lg:px-12">
					...
					>
						<span>Vendor</span>
						<span className="text-[#C4553A] transition-transform duration-300 group-hover:translate-x-0.5">
							Link
						</span>
					</Link>
					...
					<div className="hidden items-center gap-8 text-[11px] font-bold tracking-widest uppercase text-[#111]/45 md:flex">
						<Link
							href="/products"
							className="relative py-1 transition-colors hover:text-[#111] group"
						>
							Shop
