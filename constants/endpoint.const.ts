...
export const API_ENDPOINTS = {
  ...
  ORDERS: {
    ...
    VERIFY_PAYSTACK: (reference: string) => `/orders/paystack/verify/${reference}`,
  ...
  REVIEWS: {
    ...
    GET_ELIGIBILITY: (productId: string) => `/reviews/products/${productId}/eligibility`,
  ...
  ADMIN: {
    ...
    UPDATE_VENDOR_STATUS: (storeId: string) => `/admin/vendors/${storeId}/status`,
  },
  EARNINGS: {
    ...
    APPROVE_WITHDRAWAL: (id: string) => `/earnings/admin/withdrawals/${id}/approve`,
    REJECT_WITHDRAWAL: (id: string) => `/earnings/admin/withdrawals/${id}/reject`,
    PROCESS_WITHDRAWAL: (id: string) => `/earnings/admin/withdrawals/${id}/process`,
    CONFIRM_WITHDRAWAL_PAID: (id: string) => `/earnings/admin/withdrawals/${id}/confirm-paid`,
  },
